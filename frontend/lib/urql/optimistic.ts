...
export default class Optimistic {
    ...
    static job(input: GQL.Job_Insert_Input): GQL.Job | null {
        ...
        return {
            ...
            path: input.path ?? [],
            option_cut_start: input.option_cut_start ?? null,
            option_cut_end: input.option_cut_end ?? null,
            option_fade_in: input.option_fade_in ?? null,
            option_fade_out: input.option_fade_out ?? null,
            status: GQL.Job_Status_Enum_Enum.Waiting,
            workspace_id: input.workspace_id,
